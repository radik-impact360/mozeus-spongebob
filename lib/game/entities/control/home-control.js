...
.defines(function() {
	HomeControl = ig.Entity.extend({
		...
		zIndex:1,
		bg:new ig.Image('bg.png'),
		title:new ig.Image('title.png'),
		mascott:new ig.Image('tutorial.png'),

		buttonStartImage:new ig.Image('click-to-play.png'),
		buttonBGMOnImage:new ig.Image('bgm-on.png'),
		buttonBGMOffImage:new ig.Image('bgm-off.png'),
		buttonSFXOnImage:new ig.Image('sfx-on.png'),
		buttonSFXOffImage:new ig.Image('sfx-off.png'),
