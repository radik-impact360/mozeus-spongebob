...
.defines(function() {
	HomeControl = ig.Entity.extend({
		...
		buttonBGMOnImage:new ig.Image('asset/bgm-on.png'),
		buttonBGMOffImage:new ig.Image('asset/bgm-off.png'),
		buttonSFXOnImage:new ig.Image('asset/sfx-on.png'),
		buttonSFXOffImage:new ig.Image('asset/sfx-off.png'),
