...
.defines(function() {
	HomeControl = ig.Entity.extend({
		...
		mascott:new ig.Image('media/graphics/game/mascott.png'),
		logo:new ig.Image('media/graphics/game/logo.png'),
		shine:new ig.Image('media/graphics/game/shine.png'),

		buttonStartImage:new ig.Image('asset/tap-to-start.png'),
		...
		init:function(x,y,settings){
			...
			this.buttonStart = ig.game.spawnEntity(
				EntityButton,
				-this.buttonStartImage.width, ig.system.height - this.buttonStartImage.height - 50,
				{
			...
			// 	EntityButton,
			// 	-this.buttonTutorialImage.width, 1100,
			// 	{
			...
			this.tween( {posMascott:{x:ig.system.width + 100} }, 0.5, { easing : ig.Tween.Easing.Back.EaseOut, delay:0.5 }).start();
