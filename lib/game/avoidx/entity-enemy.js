...
.defines(function() {
	EntityEnemy = ig.Entity.extend({
        ...
        arrayImage:[
            new ig.Image('asset/badges/good-0.png'), // 0
            new ig.Image('asset/badges/good-1.png'), // 1
            new ig.Image('asset/badges/good-2.png'), // 2
            new ig.Image('asset/badges/good-3.png'), // 3
            new ig.Image('asset/badges/good-4.png'), // 4
            new ig.Image('asset/badges/good-5.png'), // 5
            new ig.Image('asset/badges/good-6.png'), // 6
            new ig.Image('asset/badges/good-15.png') // 7
        ],
		...
		draw:function(){
            ...
            // ctx.globalAlpha = 0.5;
            // ctx.fillRect(-this.image.width * 0.5, -this.image.height * 0.5, this.image.width, this.image.height);
