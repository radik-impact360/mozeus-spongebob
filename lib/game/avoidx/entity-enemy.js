...
.defines(function() {
	EntityEnemy = ig.Entity.extend({
        ...
        arrayImage:[
            new ig.Image('good-0.png'), // 0
            new ig.Image('good-1.png'), // 1
            new ig.Image('good-2.png'), // 2
            new ig.Image('good-3.png'), // 3
            new ig.Image('good-4.png'), // 4
            new ig.Image('good-5.png'), // 5
            new ig.Image('good-6.png'), // 6
            new ig.Image('good-15.png') // 7
        ],
