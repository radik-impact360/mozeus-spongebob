...
.defines(function() {
	EntityEmitter = ig.Entity.extend({
        ...
        arrayImage:[
            new ig.Image('asset/good-0.png'),
            new ig.Image('asset/good-1.png'),
            new ig.Image('asset/good-2.png'),
            new ig.Image('asset/good-3.png'),
            new ig.Image('asset/good-4.png'),
            new ig.Image('asset/good-5.png'),
            new ig.Image('asset/good-6.png')
        ],
