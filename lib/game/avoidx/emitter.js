...
.defines(function() {
	EntityEmitter = ig.Entity.extend({
        ...
        arrayImage:[
            new ig.Image('good-0.png'),
            new ig.Image('good-1.png'),
            new ig.Image('good-2.png'),
            new ig.Image('good-3.png'),
            new ig.Image('good-4.png'),
            new ig.Image('good-5.png'),
            new ig.Image('good-6.png')
        ],
